...
[Configure Azure Defender for open-source relational databases to be enabled](https://github.com/qtip27/MicrosoftOpenAI/blob/main/relational_database.json)
